...
interface ITenagaAhliAttributes {
	kode_tenaga_ahli : number
...
export type  TenagaAhliOutput= Required<ITenagaAhliAttributes>

export type TenagaAhliInput = Optional<
ITenagaAhliAttributes, 
"kode_tenaga_ahli" | 
"kode_vendor" | 
"nama" | 
"no_ktp" | 
...
class TenagaAhli 
    extends Model<ITenagaAhliAttributes, TenagaAhliInput>
    implements ITenagaAhliAttributes
{
	declare kode_tenaga_ahli : number
...
TenagaAhli.init(
    ...
    },
    {
        sequelize : db, 
        schema : "public",
        tableName : "ref_tenaga_ahli",
        modelName : "TenagaAhli",
        timestamps : false
    }
)

TenagaAhli.belongsTo(Vendor, {
    foreignKey : "kode_vendor",
    as : "Vendor"
})

Vendor.hasMany(TenagaAhli, {
    foreignKey : "kode_vendor",
    as : "TenagaAhli"
})
